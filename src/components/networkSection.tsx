...
const CompanyData: PartnerType[] = [
  ...
  { logo: "/assets/logo/company-partners/Card-5.png", name: "Astra International" },
  { logo: "/assets/logo/company-partners/Card-6.png", name: "Lazada" },
  { logo: "/assets/logo/company-partners/Card-7.png", name: "Shopee" },
  { logo: "/assets/logo/company-partners/Card-8.png", name: "Paragon Technology and Innovation" },
  ...
  { logo: "/assets/logo/company-partners/Card-14.png", name: "PT HM Sampoerna Tbk." },
  { logo: "/assets/logo/company-partners/Card-15.png", name: "Bank OCBC" },
  { logo: "/assets/logo/company-partners/Card-16.png", name: "Schneider Electric" },
...
export default function NetworkSection() {
  ...
  const { firstMarqueeData, secondMarqueeData } = splitUniqueData(shuffledCompanyData);

  return (
    <div className="flex flex-col items-center py-[80px] space-y-[40px]">
      <div className="font-normal text-5xl font-gilda-display">
        Our Collaborative Network
      </div>
      <div className="flex flex-col space-y-[16px] items-center">
        <Marquee companyData={firstMarqueeData} direction="right" />
        <Marquee companyData={secondMarqueeData} direction="left" />
      </div>
    </div>
  );
}
