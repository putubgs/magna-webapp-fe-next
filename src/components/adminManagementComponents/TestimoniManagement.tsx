      ...
      setTestimoniDetailData([
        {
          ...
          organization: testimoniData[index].organization,
        },
      ]);
    }
  }
  ...
  return (
    <>
          ...
          <thead>
            <tr className="border-b border-[#D4D4D4] text-left">
              ...
              {user?.role === "super-admin" && (
                <th className="text-base lg:text-lg font-bold py-3 px-4 w-[180px]">
                  Organization
                </th>
              )}
              <th className="text-base lg:text-lg font-bold py-3 px-4 w-[160px]">
                Name
              </th>
          ...
          <tbody className="relative">
            {testimoniData && testimoniData.length > 0 ? (
              ...
              <tr className="h-[250px]">
                <td colSpan={user?.role === "super-admin" ? 6 : 5}>
      ...
      <TestimoniPopUp
        ...
        showOrganizationDropdown={user?.role === "super-admin"}
      />
