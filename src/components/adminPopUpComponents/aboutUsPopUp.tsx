...
export default function AboutUsPopUp({
  ...
  const [editCardDescription, setEditCardDescription] =
  ...
  const [editTiktok, setEditTiktok] = useState<boolean>(false);
  const [editWhatsapp, setEditWhatsapp] = useState<boolean>(false);
  const [editFoundedDate, setEditFoundedDate] = useState<boolean>(false);
  ...
  // State for previous data feature
  ...
  function toggleDataView() {
    ...
    if (!showPreviousData) {
      ...
      // Switch back to current data (reset to empty for new form)
      // For edit mode, this would restore the original values
    }
  }
          ...
          <div className="bg-neutral-900 px-5 sm:px-[36px] py-[24px] space-y-[20px] sm:space-y-[32px]">
            <div className="flex justify-between items-start">
              <div className="flex items-center gap-4">
                ...
                {/* Toggle button for previous data - only show when there are pending changes */}
                {hasPendingChanges && (
                  <button
                    ...
                    {showPreviousData ? (
                      <div>
                        ...
                        <div className="flex items-center gap-x-[10px]">
                          <div
                            className="w-[30px] h-[25px] border border-neutral-700"
                      ...
                      <>
                        ...
                        <div className="flex items-center">
                          ...
                          {submited == "submit" && (
                            <div
                              onClick={() =>
                                setEditFoundedDate(!editFoundedDate)
                              }
                              className="cursor-pointer absolute right-1 sm:right-2 bottom-1 sm:bottom-2 flex items-center bg-neutral-700 gap-x-[5px] sm:gap-x-[10px] px-[8px] py-[5px] rounded-[8px]"
                            >
                              <p className="text-xs text-neutral-400">Edit</p>
