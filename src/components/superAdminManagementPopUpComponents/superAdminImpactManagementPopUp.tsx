...
type ImpactPopUpProps = {
  open: boolean;
  close: () => void;
  save: (impactData: ImpactProps, organization_name: string) => void;
};

export default function SuperAdminImpactManagementPopUp({
  open,
  close,
  save,
}: ImpactPopUpProps) {
      ...
      <div className="col-start-4 col-end-10 rounded-t-[6px]">
        <div className="relative">
          <div className="flex justify-between items-center border-b border-neutral-300 bg-black px-[24px] py-[10px] rounded-t-[6px]">
            ...
            <div
              onClick={() =>
                metricName || metricValue ? setDangerPopUp(true) : close()
              }
