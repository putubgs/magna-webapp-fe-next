		...
		<div>
			<nav className="sticky top-0 bg-black z-40 flex justify-between py-6 px-4 md:px-[120px] items-center shadow-md">
				...
				{burgerStatus && (
					<div className="flex flex-col bg-black w-48 h-40 rounded-xl absolute right-6 top-20 p-4 z-99 space-y-[12px] md:hidden">
						<Link href="#events" className="cursor-pointer" onClick={handleBurger}>
							Our Event
						</Link>
						<Link
							href="#partnership"
						...
						<Link href="#impact" className="cursor-pointer" onClick={handleBurger}>
							Our Impact
						</Link>
						<Link href="#contact" className="cursor-pointer" onClick={handleBurger}>
							Contact Us
						</Link>
					</div>
				)}
			...
			<main className="text-lg">
					...
					<div className="px-4 md:px-[120px] flex flex-col-reverse md:flex-row md:items-center md:justify-between gap-10 md:gap-32">
						<div className="space-y-7">
							...
							<p className="text-sm md:text-xl">
								Connecting top companies with motivated students through job fairs, CV
								reviews, and career prep programs.
							</p>
					...
					<div className="md:px-[120px] px-5 py-8 md:py-[96px] flex flex-col items-center max-w-screen-2xl mx-auto">
						<div className="max-w-[730px]">
							...
							<p className="mt-5">
								...
								strive for excellence, aiming to create even greater impacts in the
								years to come.
							</p>
						</div>
				...
				<section
					...
					<div className={`${gilda.className} font-normal md:text-5xl text-2xl`}>
