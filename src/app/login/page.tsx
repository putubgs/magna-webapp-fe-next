...
function Login() {
  ...
  return (
    <div className="min-w-screen max-h-screen flex">
      <div className="flex flex-col justify-center min-h-screen bg-[#171717] flex-1">
        <div className="md:hidden block w-[273px] h-[291px] bg-[#3D0FA8] opacity-50 blur-3xl rounded-full absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 z-0"></div>
        <div className="flex flex-col min-w-full h-full justify-center items-center p-10 z-10">
      ...
      <div className="pointer-events-none md:block hidden w-[40%] h-[100%] bg-[#3D0FA8] opacity-50 blur-3xl rounded-full absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2"></div>
      <div className="md:flex hidden bg-black w-full items-center justify-center flex-1 z-10">
        <Image
