			...
			<div id="organizations">
				<div className="py-[80px] px-5">
					<div className="text-center max-w-[730px] mx-auto space-y-[8px]">
						...
						<p className="text-2xl lg:text-5xl gilda-font">Magna Organizations</p>
						<p className="text-sm lg:text-base">
							Discover the diverse landscape of Magna Organizations, each dedicated to
				...
				<div className="md:px-[120px] px-5 py-[96px] flex flex-col items-center max-w-screen-2xl mx-auto">
					<div className="max-w-[730px]">
						...
						<p className="mt-5 md:text-[20px]">
							These numbers are more than just figures, they represent our dedication
							to making a meaningful difference and driving progress. We continue to
							strive for excellence, aiming to create even greater impacts in the years
							to come.
						</p>
					</div>
					<div className="w-full mt-[33px] mx-20 flex flex-wrap px-7 lg:px-0 justify-between gap-5">
						<div className="flex justify-center lg:justify-between w-full gap-5 flex-wrap border border-white border-[0.5px] rounded-xl py-6 px-2 lg:px-[80px] bg-white/[8%]">
							...
							<div className="flex flex-col items-center space-y-1 md:space-y-3">
								<h3 className="font-semibold text-2xl md:text-4xl lg:text-5xl">
									<CountUp start={0} end={200} suffix="k+" enableScrollSpy scrollSpyOnce>
										{({ countUpRef }) => <span ref={countUpRef} />}
									</CountUp>
								</h3>
								<p className="text-xs md:text-base text-center max-w-[80px] md:max-w-fit">
							...
							<div className="flex flex-col items-center space-y-1 md:space-y-3">
								<h3 className="font-semibold text-2xl md:text-4xl lg:text-5xl">
									<CountUp start={0} end={300} suffix="+" enableScrollSpy scrollSpyOnce>
										{({ countUpRef }) => <span ref={countUpRef} />}
									</CountUp>
								</h3>
								<p className="text-xs md:text-base text-center max-w-[80px] md:max-w-fit">
							...
							<div className="flex flex-col items-center space-y-1 md:space-y-3">
								<h3 className="font-semibold text-2xl md:text-4xl lg:text-5xl">
									<CountUp start={0} end={500} suffix="+" enableScrollSpy scrollSpyOnce>
										{({ countUpRef }) => <span ref={countUpRef} />}
									</CountUp>
								</h3>
								<p className="text-xs md:text-base text-center max-w-[80px] md:max-w-fit">
							...
							<div className="flex flex-col items-center space-y-1 md:space-y-3">
								<h3 className="font-semibold text-2xl md:text-4xl lg:text-5xl">
									<CountUp start={0} end={30} suffix="+" enableScrollSpy scrollSpyOnce>
										{({ countUpRef }) => <span ref={countUpRef} />}
									</CountUp>
								</h3>
								<p className="text-xs md:text-base text-center max-w-[80px] md:max-w-fit">
						...
						<div className="w-full md:w-[1200px] flex flex-col text-center items-center justify-center">
							...
							<div className="flex flex-col gap-2 md:gap-2.5 lg:gap-[26px] md:mt-0 mt-[24px] space-y-[26px] md:space-y-0">
								<p className="text-base pt-2">
									&quot;At Magna Partners, we see every young Indonesian not just as a
									participant in our nation&apos;s future, but as the driving force
									behind it. We are committed to unlocking the boundless potential within
									each youth, transforming them into visionary leaders and innovators.
									Through our support and guidance, we don&apos;t just shape
									contributors; we cultivate the architects of Indonesia&apos;s bright
