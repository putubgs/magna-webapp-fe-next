            ...
            <div className="w-full md:w-[1200px] flex flex-col text-center items-center justify-center">
              ...
              <div className="flex flex-col gap-2 md:gap-2.5 lg:gap-[26px] md:mt-0 mt-[24px] space-y-[26px] md:space-y-0">
                <p className="text-base pt-2">
                  ...
                  just as a participant in our nation&apos;s future, but as the
                  driving force behind it. We are committed to unlocking the
                  boundless potential within each youth, transforming them into
                  visionary leaders and innovators. Through our support and
                  guidance, we don&apos;t just shape contributors; we cultivate
                  the architects of Indonesia&apos;s bright and prosperous
                  tomorrow.&quot;
                </p>
